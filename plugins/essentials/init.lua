...
EssentialsPlugin.init = function()
	...
	Server.AddCommand("emote", "me", EssentialsPlugin.EmoteCommand, "&9/emote <message> - unleashes an emote upon the world", 1, 0)
	Server.AddCommand("pm", "msg message whisper m", EssentialsPlugin.PmCommand, "&9/pm <name> <message> - sends a private message to a player", 2, 0)
	Server.AddCommand("billnye", "bn bill nye", EssentialsPlugin.BillNyeCommand, "&9/billnye <wisdom> - instills wisdom in fellow server members", 1, 0)
